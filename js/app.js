...
function verProducto(idProducto) {
    // Buscar un producto dentro de la lista productos.
    ...
    const modalImagen = document.querySelector("#modalProductoImagen");
    const modalCategoria = document.querySelector("#modalProductoCategoria");
    const modalNombre = document.querySelector("#modalProductoNombre");
    const modalDescripcion = document.querySelector("#modalProductoDescripcion");
    const modalPrecio = document.querySelector("#modalProductoPrecio");

    // Completar la imagen y los textos.
    ...
    const elementoModal = document.querySelector("#modalProducto");
